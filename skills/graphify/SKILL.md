...
name: graphify
description: |
  Build and query codebase knowledge graphs. Use when: "how does X work",
  "what calls Y", "trace data flow", "build a graph", "analyze this codebase",
  "onboard to this project", "what are the god nodes", "PR impact analysis".
  Turns any folder of code/docs/papers/images/videos into a persistent
  knowledge graph with community detection, god nodes, and query tools.
  71x fewer tokens per query vs raw file reads.
argument-hint: "[path-or-query] [--mode deep] [--update] [--obsidian] [--wiki] [--mcp]"
